...
my %hash = (
  ...
  K562_DRIP_v_DRIPc => "/data/aparna/Data/K562/intersects/K562_DRIP_v_DRIPc.bed",
  K562_DRIPc_wig => "/data/aparna/Data/K562/LS42B_all.wig",
  K562_DRIP_wig => "/data/aparna/Data/K562/LS42C_treat_afterfiting_all.wig",

  genome_prom => "/data/aparna/Replication_Origins/pipeline/metaplot/stellas/genomic/genomic_promoter.bed",
  genome_term => "/data/aparna/Replication_Origins/pipeline/metaplot/stellas/genomic/genomic_terminal.bed",

  K562_oris => "/data/aparna/Replication_Origins/Picard/k562_oris/K562_oris.bed",
  K562_const_oris => "/data/aparna/Replication_Origins/Picard/k562_oris/K562_const_oris.bed",
  K562_specific_oris => "/data/aparna/Replication_Origins/Picard/k562_oris/K562_specific_oris.bed",
  K562_oris_prom_strict => "/data/aparna/Replication_Origins/Picard/k562_oris/intersects/K562_oris_strict_intersect_promoters.bed",
  K562_oris_term_strict => "/data/aparna/Replication_Origins/Picard/k562_oris/intersects/K562_oris_strict_intersect_terminals.bed",
