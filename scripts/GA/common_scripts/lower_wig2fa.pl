...
print "DEPRECIATED: use shift_wig.pl to linearly median shift wig files and use normal wig2fa.pl. This script WAS used for DRIPc, keeping as a record for that reason.\n";
