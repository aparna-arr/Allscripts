...
my $WIGFILE = "drip_wig_chr8_small"; # SET TO NAME OF WIG IN CACHE
...
my $SIG_BLOCKS = 7047; # count these beforehand! Numbers output from make_cache.pl
my $UNSIG_BLOCKS = 591491; 
my $cache = new Cache::FileCache();
$cache -> set_cache_root("/data/aparna/GA/cache2") ; # Set cache root here
...
#    elsif ($avg > $SCORE_THRESH/2 && ($first || $last)) {
